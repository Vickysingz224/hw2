...
OBJS=amazon.o user.o db_parser.o product.o product_parser.o util.o clothing.o book.o movie.o mydatastore.o
...
mydatastore.o: mydatastore.cpp mydatastore.h product.h user.h datastore.h
